...
var Key = 'pt_pin=100470789-447356;pt_key=AAJisYF6ADB3RqB1dcQitAlyX0NaVvi27yVkeTFMTQTX0n8omREV5bmoT88ne81vewDULdjKAeU;'; //单引号内自行填写您抓取的Cookie
...
function ReadCookie() {
  ...
  if(Key.length == 0) {
    console.log("请先在 JD_DailyBonus.js 文件里面配置 key，key的值为账号的cookie");
    process.exit(1)
  }
